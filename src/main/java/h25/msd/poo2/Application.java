...
public class Application {
    public static void main(String[] args) {
        ...
        // // Dessert dessert = new Dessert("pouding", 3.45, PeriodeJournee.DEJEUNER,
        // JoursSemaine.MARDI, 34);
        // // Entree entree = new Entree("soupe", 5.49, PeriodeJournee.DEJEUNER, 15,
        // 45);
        ...
        MenuItem[] items = new MenuItem[] { dessert, entree };

        if (restaurant.commande(items, client)) {
            // // System.out.println("La comande de " +client.getNom()+ " est passée");

            System.out.println("La commande de " + client.getNom() + " est passée");
        }
